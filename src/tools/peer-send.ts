...
export function createPeerSendTool(
  ...
  return defineTool({
    ...
    description: [
      ...
      'Every message costs the receiver a turn, so send only what changes what it will do.',
      'Do NOT send acknowledgements, thanks, sign-offs, or "noted" — a peer that has nothing to act on',
      'is better left working. When an exchange is finished, stop replying rather than closing it politely.',
